...
class Ceiling:
    def __init__(self, coord0, coord1, cameraTransX, cameraTransY, cameraTransZ,
        ...
        #* Create component
        self.allTriangles = self.createCeiling()
    ...
    def createCeiling(self):
        (x0, y0, z0) = self.coord0
        (x1, y1, z1) = self.coord1
        
        if ( (x0 > x1) or (y0 > y1) or (z0 > z1) ):
            raise Exception("First coordinate of createWall must be less than the second")
        ...
        triangleList.extend((triY1a, triY1b,))
